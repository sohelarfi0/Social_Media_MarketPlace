...
const ListingCard = ({listing}) => {
  ...
  return (
    <div className='relative bg-white roundeed-2xl shadow-sm border 
    bborder-gray-100 overflow-hidden hover:shadow-md transition'>
       ...
       {listing.featured &&(
        ...
        <div className='p-5 pt-8'>
            ...
            <div className='flex flex-wrap justify-between max-w-lg items-center gap-3 my-5'>
                ...
                {listing.engagement_rate && (
                    <div className='flex items-center text-sm text-gray-600'>
                        ...
                        <span className='text-lg font-medium text-slate-800 mr-1.5'>
                            {listing.engagement_rate}</span>%engagment  
            ...
            <div className='flex items-center gap-3 mb-3'>
                <span className='text-xs font-medium bg-pink-100 text-pink-600 px-3
                py-1 rounded-full capitalize'>{listing.niche}</span>
                {listing.country &&(
            ...
            <div className='flex items-center justify-between'>
                ...
                <button onClick={()=>{
                    ...
                    scrollTo(0,0)}} className='px-7 py-3 bg-indigo-600 text-white text-sm rounded-lghover:bg-indigo-700 transition'>
                        More Details
                    </button>
            </div>
        </div>
