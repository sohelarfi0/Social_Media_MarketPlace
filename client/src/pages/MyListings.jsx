  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8'>
      ...
      {/* Stats */}
        ...
        {/* Balance Section */}
        <div className='flex flex-col sm:flex-row justify-between gap-4 xl:gap-20 p-6 mb-10
                      ...
                      <div className='space-y-4'>
                        <div className='grid grid-cols-2 gap-2 text-sm'>
                          ...
                          <span className={`flex items-center justify-end gap-1 ${getStatusColor(listing.status)}`}>
                            {getStatusIcon(listing.status)}{" "}<span>
                              {listing.status}
                            </span>
                            ...
                            <div className='flex items-center space-x-2'>
                              ...
                              <span className=''>{listing.engagemnet_rate}% engagement</span>
