  ...
  if(!orders.length){
    return(
      <div className='px-4 md:px-16 lg:px-24 xl:px-32'>
        <div className='max-w-2xl mx-auto mt-14 bg-white wounded-xl border border-gray-200
        p-8 text-center'>
    ...
    <h2 className='text-2xl font-semibold mb-6'>
      ...
      <div className='space-y-4'>
        {orders.map((order)=>{
          ...
          return(
            <div key={id} className='bg-white rounded-lg border border-gray-200 p-5 flex 
            flex-col max-w-4xl'>
              ...
              <div className='flex items-start gap-4 flex-1'>
                <div className='p-2 rounded-lg bg-gray-50 max-sm:hidden'>
                  ...
                  <div className='flex-1'>
                    <div className='flex items-start justify-betweeen gap-4'>
                      <div>
                ...
                <button onClick={()=> setExpandedId((p)=>(p===id ? null : id))}
                  ...
                  aria-expanded={isExpanded}>
                    {isExpanded ? (
                      ...
                      <>
                      <ChevronUp className='size-4'/>View Credentials</>
                    )}
