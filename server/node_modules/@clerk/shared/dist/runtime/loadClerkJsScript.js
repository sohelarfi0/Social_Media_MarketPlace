...
const clerkJSScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/clerk-js@${require_versionSelector.versionSelector(__internal_clerkJSVersion)}/dist/clerk.browser.js`;
};
...
const buildScriptHost = (opts) => {
	...
	if (!!proxyUrl && require_proxy.isValidProxyUrl(proxyUrl)) return require_proxy.proxyUrlToAbsoluteURL(proxyUrl).replace(/http(s)?:\/\//, "");
