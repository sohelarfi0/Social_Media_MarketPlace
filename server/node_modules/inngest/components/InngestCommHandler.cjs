	...
	*/
	...
	constructor(options) {
		...
		*/
		...
		this.defaultMaxRuntime = options.defaultMaxRuntime ?? require_types.DefaultMaxRuntime.serve;
		...
		const resultHandler = {
			...
			"function-resolved": ({ data }) => {
				...
				return actions.transformResponse("creating sync success response", {
					...
					headers: { "Content-Type": "application/json" },
					version: exeVersion,
					body: require_strings.stringify(require_functions.undefinedToNull(data))
				});
			},
