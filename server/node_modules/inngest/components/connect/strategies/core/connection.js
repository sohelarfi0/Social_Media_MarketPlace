import { ConnectMessage, GatewayMessageType, gatewayMessageTypeToJSON } from "../../../../proto/src/components/connect/protobuf/connect.js";
...
var ConnectionCore = class {
	...
	constructor(config, callbacks) {
		...
		this.requestProcessor = new RequestProcessor(accessor, wakeSignalRef, callbacks, callbacks.logger);
	}
	get connectionId() {
