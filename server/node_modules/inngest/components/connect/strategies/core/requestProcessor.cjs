...
var RequestProcessor = class {
	...
	async handleExecutorRequest(connectMessage, conn) {
		...
		conn.ws.send(require_buffer.ensureUnsharedArrayBuffer(require_connect.ConnectMessage.encode(require_connect.ConnectMessage.create({
		...
		extendLeaseInterval = setInterval(() => {
			...
			try {
				latestConn.ws.send(require_buffer.ensureUnsharedArrayBuffer(require_connect.ConnectMessage.encode(require_connect.ConnectMessage.create({
		...
		try {
			...
			this.accessor.activeConnection.ws.send(require_buffer.ensureUnsharedArrayBuffer(require_connect.ConnectMessage.encode(require_connect.ConnectMessage.create({
...
//# sourceMappingURL=requestProcessor.cjs.map