...
let __bufbuild_protobuf_wire = require("@bufbuild/protobuf/wire");
...
let GatewayMessageType = /* @__PURE__ */ function(GatewayMessageType$1) {
	...
	GatewayMessageType$1[GatewayMessageType$1["WORKER_STATUS"] = 15] = "WORKER_STATUS";
...
function gatewayMessageTypeFromJSON(object) {
	switch (object) {
		...
		case 15:
		case "WORKER_STATUS": return GatewayMessageType.WORKER_STATUS;
		case -1:
		case "UNRECOGNIZED":
...
function gatewayMessageTypeToJSON(object) {
	switch (object) {
		...
		case GatewayMessageType.WORKER_STATUS: return "WORKER_STATUS";
...
const ConnectMessage = {
	encode(message, writer = new __bufbuild_protobuf_wire.BinaryWriter()) {
		if (message.kind !== 0) writer.uint32(8).int32(message.kind);
		if (message.payload.length !== 0) writer.uint32(18).bytes(message.payload);
		return writer;
	},
	decode(input, length) {
		const reader = input instanceof __bufbuild_protobuf_wire.BinaryReader ? input : new __bufbuild_protobuf_wire.BinaryReader(input);
...
const WorkerConnectRequestData = {
	encode(message, writer = new __bufbuild_protobuf_wire.BinaryWriter()) {
		...
		if (message.startedAt !== void 0) require_timestamp.Timestamp.encode(toTimestamp(message.startedAt), writer.uint32(106).fork()).join();
	...
	decode(input, length) {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 13:
					if (tag !== 106) break;
					message.startedAt = fromTimestamp(require_timestamp.Timestamp.decode(reader, reader.uint32()));
					continue;
				case 14:
					if (tag !== 112) break;
...
const GatewayConnectionReadyData = {
	encode(message, writer = new __bufbuild_protobuf_wire.BinaryWriter()) {
		...
		if (message.statusInterval !== "") writer.uint32(26).string(message.statusInterval);
		return writer;
	},
	decode(input, length) {
		const reader = input instanceof __bufbuild_protobuf_wire.BinaryReader ? input : new __bufbuild_protobuf_wire.BinaryReader(input);
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 3:
					if (tag !== 26) break;
					message.statusInterval = reader.string();
					continue;
			}
			if ((tag & 7) === 4 || tag === 0) break;
			reader.skip(tag & 7);
	...
	fromJSON(object) {
		return {
			...
			statusInterval: isSet(object.statusInterval) ? globalThis.String(object.statusInterval) : ""
		};
	},
	toJSON(message) {
		const obj = {};
		...
		if (message.statusInterval !== "") obj.statusInterval = message.statusInterval;
		return obj;
	},
	create(base) {
	...
	fromPartial(object) {
		...
		message.statusInterval = object.statusInterval ?? "";
		return message;
	}
};
function createBaseWorkerStatusData() {
	return {
		inFlightRequestIds: [],
...
const WorkerStatusData = {
	encode(message, writer = new __bufbuild_protobuf_wire.BinaryWriter()) {
		for (const v of message.inFlightRequestIds) writer.uint32(10).string(v);
		if (message.shutdownRequested !== false) writer.uint32(16).bool(message.shutdownRequested);
		return writer;
	},
	decode(input, length) {
		const reader = input instanceof __bufbuild_protobuf_wire.BinaryReader ? input : new __bufbuild_protobuf_wire.BinaryReader(input);
		let end = length === void 0 ? reader.len : reader.pos + length;
		const message = createBaseWorkerStatusData();
		while (reader.pos < end) {
			const tag = reader.uint32();
			switch (tag >>> 3) {
				case 1:
					if (tag !== 10) break;
					message.inFlightRequestIds.push(reader.string());
					continue;
				case 2:
					if (tag !== 16) break;
					message.shutdownRequested = reader.bool();
					continue;
			}
			if ((tag & 7) === 4 || tag === 0) break;
			reader.skip(tag & 7);
	...
	fromJSON(object) {
		return {
			inFlightRequestIds: globalThis.Array.isArray(object?.inFlightRequestIds) ? object.inFlightRequestIds.map((e) => globalThis.String(e)) : [],
			shutdownRequested: isSet(object.shutdownRequested) ? globalThis.Boolean(object.shutdownRequested) : false
		};
	},
	toJSON(message) {
		const obj = {};
		if (message.inFlightRequestIds?.length) obj.inFlightRequestIds = message.inFlightRequestIds;
		if (message.shutdownRequested !== false) obj.shutdownRequested = message.shutdownRequested;
		return obj;
	},
	create(base) {
		return WorkerStatusData.fromPartial(base ?? {});
	},
	fromPartial(object) {
		const message = createBaseWorkerStatusData();
		message.inFlightRequestIds = object.inFlightRequestIds?.map((e) => e) || [];
		message.shutdownRequested = object.shutdownRequested ?? false;
		return message;
	}
};
...
function fromJsonTimestamp(o) {
	...
	else return fromTimestamp(require_timestamp.Timestamp.fromJSON(o));
}
...
exports.FlushResponse = FlushResponse;
exports.GatewayConnectionReadyData = GatewayConnectionReadyData;
exports.GatewayExecutorRequestData = GatewayExecutorRequestData;
exports.GatewayMessageType = GatewayMessageType;
exports.SDKResponse = SDKResponse;
exports.SDKResponseStatus = SDKResponseStatus;
exports.StartRequest = StartRequest;
exports.StartResponse = StartResponse;
exports.WorkerConnectRequestData = WorkerConnectRequestData;
exports.WorkerDisconnectReason = WorkerDisconnectReason;
exports.WorkerReplyAckData = WorkerReplyAckData;
exports.WorkerRequestAckData = WorkerRequestAckData;
exports.WorkerRequestExtendLeaseAckData = WorkerRequestExtendLeaseAckData;
exports.WorkerRequestExtendLeaseData = WorkerRequestExtendLeaseData;
exports.WorkerStatusData = WorkerStatusData;
